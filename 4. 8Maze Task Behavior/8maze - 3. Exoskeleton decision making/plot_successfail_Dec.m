function [x,y,x1,y1,datas,dataf] = plot_successfail_Dec(Decisions,n,k)
...
M1f = [sum(Decisions.M1D1.fail);...
      ...
      sum(Decisions.M1D9.fail);...
      sum(Decisions.M1D10.fail);...
      sum(Decisions.M1D11.fail);...
      sum(Decisions.M1D12.fail)];
...
M2f = [sum(Decisions.M2D1.fail);...
      ...
      sum(Decisions.M2D9.fail);...
      sum(Decisions.M2D10.fail);...
      sum(Decisions.M2D11.fail);...
      sum(Decisions.M2D12.fail)];
...
M1s = [sum(Decisions.M1D1.success);...
      ...
      sum(Decisions.M1D9.success);...
      sum(Decisions.M1D10.success);...
      sum(Decisions.M1D11.success);...
      sum(Decisions.M1D12.success)];
...
M2s = [sum(Decisions.M2D1.success);...
      ...
      sum(Decisions.M2D9.success);...
      sum(Decisions.M2D10.success);...
      sum(Decisions.M2D11.success);...
      sum(Decisions.M2D12.success)];
